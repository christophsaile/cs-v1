...
export default (
	...
	return render`
		${createStyle(styles)}
		<div>
			<div ref=${refs.showMoreRef} class="showMore ${data.menuOpen ? 'menuOpen': ''}">
				<span ref=${refs.showMoreTextRef} class="showMore__text" >${data.text}</span>
				<span ref=${refs.showMoreIconRef}>
