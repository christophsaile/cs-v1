...
class PortfolioCursor extends Component<
	PortfolioCursorProps,
	PortfolioCursorState
> {
	public static componentName = "portfolio-cursor";
	public static attributes = [];

	protected readonly defaultProps: PortfolioCursorProps = {};

	protected readonly defaultState: PortfolioCursorState = {};

	public methods: PortfolioCursorMethods = {};
